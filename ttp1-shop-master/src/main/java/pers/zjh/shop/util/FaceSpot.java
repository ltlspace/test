...
public class FaceSpot {
    ...
    private static final String AppID = "22299516";
    private static final String APIKey = "57lXVU1bsMUOVGZl6r7snIdE";
    private static final String SecretKey = "45YE2DeZmDjFK9fn6Cept6qufspCRMbd";
